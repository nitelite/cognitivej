...
public class EmotionScenario {
     ...
     *
     * @param imageUrl the url to find the single face with emotion.
     * @return the found face with emotion
     * @throws SingleFaceNotFoundException thrown if a single face is not found
     */
    @NotNull
     ...
     * Find a single face with emotion within a given url
     *
     * @param image the local image to find the single face with emotion
     * @return the found face with emotion
